        ...
        >
            <div className="stack-large">
                ...
                <section>
                    ...
                    <h5>見出し５です</h5>
                    <h6>見出し６です</h6>
                    <p>ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝たしはでまた箱のダミーコピーです上手。</p>
                    <p className="font-size:biggish">.font-size:biggish。ここからユーティリティクラスで文字サイズ変更。ダミーコピーでセロに思ったばこだた。勝たしはでまた箱のダミーコピーです上手。</p>
                ...
                <section className="stack-small">
                    ...
                    <div className="stack outline-1 outline-cyan-500">
                        <div className="outline-1 outline-fuchsia-400">
                            <div className="outline-1 outline-lime-400">ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。</div>
                            <div className="outline-1 outline-lime-400">ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。</div>
                        </div>
                        <div className="outline-1 outline-fuchsia-400">直下、かつ前に兄弟要素ある場合のみ上余白が空く。屋をに思ったばこだた。</div>
                        <div className="outline-1 outline-fuchsia-400">ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。</div>
                    </div>

                    <div className="stack stack-exception outline-1 outline-cyan-500">
                        <div className="outline-1 outline-fuchsia-400">
                            <div className="outline-1 outline-lime-400">カスタムプロパティのオーバーライドを適用する例外クラスで空きを変更。</div>
                            <div className="outline-1 outline-lime-400">ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。</div>
                        </div>
                        <div className="outline-1 outline-fuchsia-400">直下、かつ前に兄弟要素ある場合のみ上余白が空く。屋をに思ったばこだた。</div>
                        <div className="outline-1 outline-fuchsia-400">ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。</div>
                    ...
                    <div className="stack-card outline-1 outline-amber-400">
                        <div className="outline-1 outline-fuchsia-400">stack-card。2つ目の要素が縦いっぱいに広がる？屋をに思ったばこだた。</div>
                        <div className="outline-1 outline-fuchsia-400">ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。</div>
                    </div>
                </section>
                ...
                <section className="stack-small">
                    <h2>The Box</h2>
                    <div className="box">
                        <p>.box。ミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだたから思わ口まし勝た。</p>
                    </div>

                    <div className="box invert">
                        <p>.box.invert。モノクロ以外は難しい。ダミーコピーです手はおっかさんの演奏硝子屋をセロに。</p>
                    </div>

                    {/*<div className="box" style="--color-dark:maroon;--color-light:#ffffbf">*/}
                    <div className="box">
                        <p>インラインでCSSカスタムプロパティを指定。ダミーコピーです手はおっかさんの演奏硝子屋をセロ</p>
                    </div>
                </section>
                ...
                <section className="stack-small">
                    ...
                    <div className="switcher">
                        <div className="bg-gray-200">
                            <p>★★４つ以下で横並びに。っかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝た(50)しはでまた箱の</p></div>
                        <div className="bg-gray-200">
                            <p>★★ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝た(50)しはでまた箱の</p></div>
                        <div className="bg-gray-200">
                            <p>★★ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝た(50)しはでまた箱の</p></div>
                        <div className="bg-gray-200">
                            <p>★★ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝た(50)しはでまた箱の</p></div>
                    ...
                    <div className="switcher">
                        <div className="bg-gray-200">
                            <p>★★5つ以上で垂直レイアウトに。の演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝た(50)しはでまた箱の</p></div>
                        <div className="bg-gray-200">
                            <p>★★ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝た(50)しはでまた箱の</p></div>
                        <div className="bg-gray-200">
                            <p>★★ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝た(50)しはでまた箱の</p></div>
                ...
                <section className="stack-small">
                    ...
                    <div className="cover bg-gray-200">
                        ...
                        <div className="cover__main bg-gray-200">
                            Cover Main
                        </div>
                        <div className="bg-amber-100">
                            footer
                ...
                <div className="stack-small">
                    <h2>The Grid</h2>
                    <div className="grid">
                        <div>ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝たしはでまた箱のダミーコピーです上手どもっさと俄たますて</div>
                        <div>ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝たしはでまた箱のダミーコピーです上手どもっさと俄たますて</div>
                        <div>ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝たしはでまた箱のダミーコピーです上手どもっさと俄たますて</div>
                        <div>ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝たしはでまた箱のダミーコピーです上手どもっさと俄たますて</div>
                        <div>ダミーコピーです手はおっかさんの演奏硝子屋をセロに思ったばこだた。それから思わ口まし勝たしはでまた箱のダミーコピーです上手どもっさと俄たますて</div>
