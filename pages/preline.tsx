...
const Preline: NextPage = () => {
    return (
        ...
        >
            ...
            <hr className="my-10" />
            <section>
                <div className="bg-white border rounded-xl shadow-sm sm:flex mx-3 md:mx-0 dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                  <div className="flex-shrink-0 relative w-full rounded-t-xl overflow-hidden sm:rounded-l-xl sm:max-w-[15rem] md:rounded-tr-none md:max-w-xs">
                    <Image
